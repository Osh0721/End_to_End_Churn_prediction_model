...
from Model_processing.model_evaluation import ModelEvaluator
...
def training_pipeline(
                    data_path: str = 'data/raw/CEHHbInToW.csv',
    ...
    try:
        ...
        evaluation_results_cp.pop('confusion_matrix', None)
        ...
        logger.info(f"  • Model Performance - F1 Score: {evaluation_results.get('f1_score', 'N/A'):.4f}")
